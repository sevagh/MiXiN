...
def parse_args():
    ...
    parser.add_argument("--plot-training", action="store_true", help="generate training plots")
    parser.add_argument(
        "--n-pool",
        type=int,
    ...
    parser.add_argument(
        "--data-clean",
        action="store_true",
        help="delete data before re-prepping"
    )
    parser.add_argument(
        "--train-clean",
        action="store_true",
...
def train_network(args):
    ...
    with h5py.File(data_hdf5_file, "r") as hf:
        ...
        Y_train = numpy.reshape(Y_train, (Y_train.shape[0], 1, 1025*22))
        ...
        Y_test = numpy.reshape(Y_test, (Y_test.shape[0], 1, 1025*22))
